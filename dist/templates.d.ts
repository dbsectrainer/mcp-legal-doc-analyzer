 ...
 */
export declare function loadAllTemplates(customDir?: string): Promise<Map<string, Template>>;
/**
 * Get a template by name (case-insensitive).
 */
export declare function getTemplate(templates: Map<string, Template>, name: string): Template | undefined;
/**
