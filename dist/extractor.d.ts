 ...
 */
export declare function loadCustomClausePatterns(filePath: string): Record<string, ClausePatternConfig>;
/**
 * Merge built-in patterns with custom patterns.
 * Custom patterns override built-ins with the same name.
 */
export declare function buildClausePatterns(customPatternsFile?: string): Record<string, ClausePatternConfig>;
/**
 ...
 */
export declare function extractClauses(text: string, confidenceThreshold?: number, customPatternsFile?: string): ExtractedClause[];
export {};
