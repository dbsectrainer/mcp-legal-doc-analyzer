 ...
 */
export declare function toolExtractClauses(filePath: string, config: ServerConfig, db: LegalDb | null, onLowConfidence?: (filePath: string, clauseType: string, confidence: number) => void, onProgress?: (step: number, total: number, description: string) => void): Promise<string>;
/**
 * flag_risks tool handler.
 * Extracts clauses, applies template rules, returns ranked findings.
 */
export declare function toolFlagRisks(filePath: string, templateName: string | undefined, templates: Map<string, Template>, config: ServerConfig, db: LegalDb | null): Promise<string>;
/**
 * summarize_terms tool handler.
 * Generates a plain-English bullet-point summary of key provisions.
 */
export declare function toolSummarizeTerms(filePath: string, config: ServerConfig): Promise<string>;
