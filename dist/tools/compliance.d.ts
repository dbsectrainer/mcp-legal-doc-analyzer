 ...
 */
export declare function toolCheckCompliance(filePath: string, templateName: string | undefined, templates: Map<string, Template>, config: ServerConfig, _db: LegalDb | null): Promise<string>;
