...
import type { ExtractedClause, RiskFinding, ServerConfig, Template } from "../types.js";
...
function computeFindings(clauses: ExtractedClause[], template: Template): RiskFinding[] {
...
function buildClausesTable(clauses: ExtractedClause[]): string {
  if (clauses.length === 0) {
...
function buildFindingsTable(findings: RiskFinding[]): string {
